...
# $conn is a veriable in database.php we accessed that veriable in this progam below 
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		$new_post = "INSERT INTO post (user_id, post_title, post_category, post_content, post_date) value ('$ID','$title', '$category', '$content', '$date')";
		...
		if (mysqli_query($conn, $new_post)) {
			#if condition
			$popup ="Successfully added your post...!</br> redirect to Profile <a href='profile.php'>click here</a>";
		} 
		else {
			#else condition 
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 offset-md-1">
						...
						<p style="margin-bottom: 00px;"><strong>Post Title</strong></p><input type="text" required="" minlength="4" maxlength="50" name="title">
						<p style="margin-bottom: 00px;"><strong>Post Category (story/blog/poem/conversation)</strong></p><input type="text" required="" minlength="4" maxlength="20" name="category">
						<div class="intro"></div>
						<p style="margin-bottom: 00px;"><strong>Post Content</strong></p><textarea style="max-width: 100%; min-width: 100%; min-height: 400px;" required="" minlength="48" name="content" maxlength="65000"></textarea>
						<div class="row">
